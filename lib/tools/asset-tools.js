    ...
    return defineTool({
        ...
        async execute(args, exec) {
            ...
            for (const [from, to] of [
                ...
                // 第三批资产：场景契约与语言基因是「设定」而非「正文」，克隆必须带走，
                // 否则新书丢了悬念保护与人物口吻（批次 3 落地时漏了这一处）。
            ...
            return { book: newBook, from_book: fromBook, action: 'clone', chapters, missing, new_stage: 'topic', next: `克隆完成：《${novel.title}》已就绪（阶段重置 topic，提案与熔断计数已清空）` };
        },
