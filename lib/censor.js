...
/** 未成年红线：主体词 × 亲密词 邻近共现。 */
/* 年龄词含阿拉伯数字写法；十八岁不列（成年线，列了会误伤大学生设定）。 */
const MINOR_SUBJECTS = ['未成年', '未成年人', '小学生', '初中生', '幼女', '幼童', '儿童', '童养媳', '高中生', '十一岁', '十二岁', '十三岁', '十四岁', '十五岁', '十六岁', '十七岁', '11岁', '12岁', '13岁', '14岁', '15岁', '16岁', '17岁'];
/* 亲密词只用完整词组——单字「性」会把 性格/理性/可能性 全部卷进来（M5）。 */
const INTIMACY_WORDS = ['亲吻', '舌吻', '拥抱入怀', '同床', '床戏', '发生关系', '情欲', '肉体', '赤裸', '脱光', '抚摸', '呻吟', '婚约', '恋人', '女友', '男友', '性爱', '性行为', '性器官'];
