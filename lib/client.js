...
var okStyle = { color: "#2a7", fontSize: "12px" };
...
var dangerBtnStyle = { ...btnStyle, color: "#c33" };
var primaryBtnStyle = { ...btnStyle, borderColor: "#2a7", color: "#156" };
var accentBtnStyle = { ...btnStyle, borderColor: "#29a", color: "#156" };
  ...
  return h(
    ...
    h(
      ...
      h(
        ...
        h("span", { style: vStyle }, "17 个 novel_* 工具已注册")
      ),
      h(
        "div",
        { style: rowStyle },
